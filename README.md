...
697 automated tests, all passing, covering everything except the ScriptHookVDotNet
...
| [docs/WATCHER.md](docs/WATCHER.md) | The watcher: what it records when something breaks, what it takes out first, and why nothing is sent by default |
